...
export default function CheckTable(props) {
  ...
  const tableData = useMemo(
    () => [
      {
        patient: ["Aman Kumar", true],
        bmi: 22.5,
        dietPlan: "Low Carb",
        consultationDate: "2024-11-01",
        followUpNeeded: true,
      },
      {
        patient: ["Ansh Shrivastav", false],
        bmi: 28.1,
        dietPlan: "Keto",
        consultationDate: "2024-11-5",
        followUpNeeded: false,
      },
      {
        patient: ["Sparsh Jaggi", true],
        bmi: 31.0,
        dietPlan: "Mediterranean",
        consultationDate: "2024-11-10",
        followUpNeeded: true,
      },
      {
        patient: ["Aayush Gupta", false],
        bmi: 24.7,
        dietPlan: "Paleo",
